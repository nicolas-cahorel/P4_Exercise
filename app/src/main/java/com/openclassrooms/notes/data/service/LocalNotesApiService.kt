...
/**
 * Implementation of the [NotesApiService] interface that stores notes locally.
 *
 * This class provides methods to add a note and retrieve all notes. Currently, the notes are
 * hardcoded for demonstration purposes.
 */
class LocalNotesApiService : NotesApiService {

    /**
     * Adds a new note to the local storage.
     *
    ...
    /**
     * Retrieves all notes from the local storage.
     *
